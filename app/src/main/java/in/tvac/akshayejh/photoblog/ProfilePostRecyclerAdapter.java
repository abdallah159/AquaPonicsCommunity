...
public class ProfilePostRecyclerAdapter extends RecyclerView.Adapter<ProfilePostRecyclerAdapter.ViewHolder> {
    ...
    public ProfilePostRecyclerAdapter(List<BlogPost> blog_list){
        ...
        //User Data will be retrieved here...
            ...
            firebaseFirestore.collection("Posts/" + blogPostId + "/Comments").addSnapshotListener(new EventListener<QuerySnapshot>() {
                ...
                public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                    ...
                    if (!documentSnapshots.isEmpty()) {
                        ...
                        holder.updateCommentsCount(commentsCount);
            ...
            holder.blogImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    fullScreenIntent.setData(Uri.parse(image_url));
            ...
            holder.deletePost.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    firebaseFirestore.collection("Posts").document(blog_list.get(position).BlogPostId)
                            .delete()
